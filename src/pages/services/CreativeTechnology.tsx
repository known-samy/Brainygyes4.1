...
const CreativeTechnology = () => {
  ...
  const technologies = [
    "Three.js", "Unity", "Unreal Engine", "WebGL", "TensorFlow", "OpenAI", "ARKit", "WebXR"
  ];

  return (
    <main className="bg-background min-h-screen">
      <SEOHead
        title="Creative Technology Services | BrainyGyes Technology"
        description="Innovative creative technology solutions including AR, VR, 3D graphics, AI integration, and interactive web experiences for unique digital solutions."
        keywords="creative technology, AR VR development, 3D visualization, AI integration, interactive experiences, Three.js, WebGL, immersive technology"
        canonicalUrl="https://www.brainygyes.com/services/creative-technology"
      />
      <Navbar />
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
              Innovative solutions leveraging cutting-edge technologies like AR, VR, AI, 
              and interactive experiences to differentiate your brand in the market.
            </p>
          </motion.div>
        </div>
      </section>
