...
const WebDevelopment = () => {
  ...
  const technologies = [
    "React", "Next.js", "TypeScript", "Node.js", "Tailwind CSS", "PostgreSQL", "MongoDB", "GraphQL"
  ];

  return (
    <main className="bg-background min-h-screen">
      <SEOHead
        title="Web Development Services | BrainyGyes Technology"
        description="Custom web development services using React, Next.js, and modern frameworks. We build responsive, SEO-optimized websites and web applications."
        keywords="web development, React development, Next.js, custom websites, responsive design, web applications, frontend development"
        canonicalUrl="https://www.brainygyes.com/services/web-development"
      />
      <Navbar />
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
              ...
              for optimal performance, scalability, and exceptional user experience.
            </p>
          </motion.div>
        </div>
      </section>
